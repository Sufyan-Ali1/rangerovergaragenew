                ...
                <div className="bg-slate-900 text-white p-10 rounded-[2rem] border border-primary/20 shadow-2xl relative overflow-hidden group">
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="py-4">
                        <span className="text-[10px] text-gray-500 font-black uppercase tracking-[0.3em] block mb-4">Or Call Specialists</span>
                        ...
                        <a href="tel:+447477733313" className="flex items-center justify-center gap-4 text-white hover:text-primary transition-colors font-black text-xl tracking-wider">
                          <Phone className="w-5 h-5 text-primary" />
                          07477 733313
                        </a>
                      </div>
