          ...
          >
            {submitted ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                <button
                  onClick={() => { setSubmitted(false); setFormData({ name: "", email: "", phone: "", postcode: "", message: "", reg: "", captchaInput: "" }); }}
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div>
                    <span className="text-[9px] font-bold text-gray-400 uppercase tracking-widest block mb-2 ml-1">Vehicle Registration*</span>
                  ...
                  <div className="flex flex-col md:flex-row items-center gap-6 p-6 bg-gray-50/50 dark:bg-slate-800/50 rounded-2xl border border-gray-100 dark:border-slate-700">
                    <div className="flex-1 text-center md:text-left">
                      <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest block mb-2">Human Verification</span>
                      <p className="text-xl font-black text-slate-900 dark:text-white">What is {captcha.n1} + {captcha.n2}?</p>
                    </div>
                    <div className="w-24">
                      <input
                        ...
                        placeholder="?"
                        className="w-full bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl py-3.5 text-center text-primary text-xl font-black focus:ring-2 focus:ring-primary outline-none shadow-sm"
                      />
                    </div>
                  </div>
